    ...
    return (
        <>
            <Helmet>
                <meta
                    name="description"
                    content={statusLoading === "error" || statusLoading === "idle" || statusLoading === "loading" ? null : `Coffee shop product ${data.cardName}`}
                />
                <title>{statusLoading === "error" || statusLoading === "idle" || statusLoading === "loading" ? null : `Coffee shop product ${data.cardName}`}</title>
            </Helmet>
            <motion.section
                initial="hidden"
                whileInView="visible"
